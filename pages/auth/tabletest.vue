    ...
    <v-row>
        <v-col class="text-center" v-if="isAuthenticated">
            ...
            <v-col class="text-left">
                ...
                <v-data-table :headers="headers" :items="desserts" :items-per-page="5" class="elevation-1" light>
                </v-data-table>
            </v-col>
            <v-container fluid>
                <v-row>
            ...
            <v-col class="text-left">
                ...
                <v-card light>
                    ...
                    <v-data-table :headers="headers" :items="desserts" :search="search" light></v-data-table>
                </v-card>
            </v-col>
