...
const BASEURL = 'https://elibx.jaja.id/'
...
export default {
  ...
  head: {
    titleTemplate: `%s - nuxtjs-vuetify-dashboard${(!isProduction && ' - Dev') || ''
      }`,
    title,
    description,
    htmlAttrs: {
    ...
    link: [
      ...
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      {
        rel: 'stylesheet',
        hid: 'font-stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@100;200;300;400;700;900&Montserrat:wght@100;200;300;400;500;600;700;800;900&Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap'
      }
    ]
  },
  ...
  auth: {
    ...
    strategies: {
      local: {
        endpoints: {
          login: { url: 'auth/loginPenerbit', method: 'post', propertyName: 'data.token' },
